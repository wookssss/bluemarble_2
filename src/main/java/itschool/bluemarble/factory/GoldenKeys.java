...
public class GoldenKeys extends Tile {
    ...
    // 인스턴스 초기화 블록
    {
        goldenKeyList.addAll(Arrays.asList(
                ...
                new Goldenkey("서울로 이동", (InstantFunction) ((player) -> player.moveByAbsoluteValue(39))), // 뒤로 3칸 이동
                ...
                new Goldenkey("부산으로 이동", (InstantFunction) ((player) -> player.moveByAbsoluteValue(25))) // 부산으로로 이동
        ));
